...
variable "existing_resource_group" {
  type        = string
  description = "Existing resource group name used to provision resources"
}

variable "existing_key_management_name" {
  type        = string
  description = "Existing key management instance for the stack"
}

variable "existing_cos_instance_name" {
  type        = string
  description = "Existing Cloud Object Storage name that will be used for VPC flow logs"
}
